...
def shop_window(current_player):
    ...
    while not finished:
        ...
        guide_text1 = ui.render_outline('LEFT CLICK - BUY x1', ui.pygame.font.Font(TERMINATOR_FONT_PATH, 13), WHITE,
                                        BLACK, 1)
        guide_text2 = ui.render_outline('RIGHT CLICK - BUY x10', ui.pygame.font.Font(TERMINATOR_FONT_PATH, 13), WHITE,
                                        BLACK, 1)
